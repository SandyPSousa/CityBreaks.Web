...
//            Console.WriteLine($"Nome antigo: {existingProperty.Name}");
//            Console.WriteLine($"Nome novo: {Property.Name}");
//            Console.WriteLine($"Preço antigo: {existingProperty.PricePerNight}");
//            Console.WriteLine($"Preço novo: {Property.PricePerNight}");
